...
export const motionMap: Record<Preset, Motion> = {
  ...
  'rotate-clockwise': { rotate: { variant: 'clockwise', duration: DURATION, delay: DELAY } },
  'rotate-counterclockwise': { rotate: { variant: 'counterclockwise', duration: DURATION, delay: DELAY } },
